function suite2_cvxN(matClass,N)
%% test_cvxbqp1
...
for i=N
 ...
 [c5ax1,c5ay1] = CBCD1(A_amd, b1_amd, d, iters,pre1,l,u,init);
    ...
    save([saveDir 'b2/figure_A5amd.mat'],...
 ...
 [c5rx1,c5ry1] = CBCD1(A_rcm, b1_rcm, d, iters,pre1,l,u,init);
    ...
    save([saveDir 'b2/figure_A5rcm.mat'],...
...
%log file
    fid = fopen([saveDir 'b2/' logfilename],'w+');
