function test_suite_cvx(matClass, gamma)
%% test_cvxbqp1
% with amd and rcm, rand and randn of b
%% set path
addpath ../../BCD
dataPath=['/home/yu/datasets/SuiteSparse/' matClass '_problem/cvx/'];
savePath=['/home/yu/bcd/SuiteSparse/result/' matClass '_problem/cvx/'];
...
for i=1:size(matList,1)
    ...
    saveDir = [savePath matList(i).name(1:end-4) '_b=' num2str(gamma) '/'];
