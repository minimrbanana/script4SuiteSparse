function test_suite_cvx3(matClass)
%% test_cvxbqp1
...
for i=1:size(matList,1)
    ...
    A=A+D;
    % set b, want almost all of the elements on the constraints
    x=rand(d,1);
    x3=x-1;
  ...
  [c0x1,c0y1] = CBCD1(A, b1, d, iters,pre1,l,u,init);
    ...
    disp('----------------------------------------');
    disp(['||EXP: ' matClass  '(b3); i=' num2str(i) '/' num2str(size(matList,1)) '; A_0 done  ||']);
    disp('----------------------------------------');
  ...
  [c5x1,c5y1] = CBCD1(A, b1, d, iters,pre1,l,u,init);
    ...
    disp('----------------------------------------');
    disp(['||EXP: ' matClass  '(b3); i=' num2str(i) '/' num2str(size(matList,1)) '; A_5 done  ||']);
    disp('----------------------------------------');
 ...
 [c0ax1,c0ay1] = CBCD1(A_amd, b1_amd, d, iters,pre1,l,u,init);
    ...
    disp('----------------------------------------');
    disp(['||EXP: ' matClass  '(b3); i=' num2str(i) '/' num2str(size(matList,1)) '; A_amd_0 done  ||']);
    disp('----------------------------------------');
 ...
 [c1ax1,c1ay1] = CBCD1(A_amd, b1_amd, d, iters,pre1,l,u,init);
    ...
    disp('----------------------------------------');
    disp(['||EXP: ' matClass  '(b3); i=' num2str(i) '/' num2str(size(matList,1)) '; A_amd_1 done  ||']);
    disp('----------------------------------------');
 ...
 [c5ax1,c5ay1] = CBCD1(A_amd, b1_amd, d, iters,pre1,l,u,init);
    ...
    disp('----------------------------------------');
    disp(['||EXP: ' matClass  '(b3); i=' num2str(i) '/' num2str(size(matList,1)) '; A_amd_5 done  ||']);
    disp('----------------------------------------');
 ...
 [c0rx1,c0ry1] = CBCD1(A_rcm, b1_rcm, d, iters,pre1,l,u,init);
    ...
    disp('----------------------------------------');
    disp(['||EXP: ' matClass  '(b3); i=' num2str(i) '/' num2str(size(matList,1)) '; A_rcm_0 done  ||']);
    disp('----------------------------------------');
 ...
 [c1rx1,c1ry1] = CBCD1(A_rcm, b1_rcm, d, iters,pre1,l,u,init);
    ...
    disp('----------------------------------------');
    disp(['||EXP: ' matClass  '(b3); i=' num2str(i) '/' num2str(size(matList,1)) '; A_rcm_1 done  ||']);
    disp('----------------------------------------');  
 ...
 [c5rx1,c5ry1] = CBCD1(A_rcm, b1_rcm, d, iters,pre1,l,u,init);
    ...
    disp('----------------------------------------');
    disp(['||EXP: ' matClass  '(b3); i=' num2str(i) '/' num2str(size(matList,1)) '; A_rcm_5 done  ||']);
    disp('----------------------------------------');
