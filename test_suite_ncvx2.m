function test_suite_ncvx2(matClass)
%% test_cvxbqp1
...
%     % x3 in 
  ...
  [c0x1,c0y1] = CBCD1(A, b1, d, iters,pre1,l,u,init);
    ...
    disp('----------------------------------------');
    disp(['||Suite ncvx: ' matClass  '(b2); i=' num2str(i) '/' num2str(size(matList,1)) '; A_0 done  ||']);
    disp('----------------------------------------');
  ...
  [c1x1,c1y1] = CBCD1(A, b1, d, iters,pre1,l,u,init);
    ...
    disp('----------------------------------------');
    disp(['||Suite ncvx: ' matClass  '(b2); i=' num2str(i) '/' num2str(size(matList,1)) '; A_1 done  ||']);
    disp('----------------------------------------');
 ...
 [c0ax1,c0ay1] = CBCD1(A_amd, b1_amd, d, iters,pre1,l,u,init);
    ...
    disp('----------------------------------------');
    disp(['||Suite ncvx: ' matClass  '(b2); i=' num2str(i) '/' num2str(size(matList,1)) '; A_amd_0 done  ||']);
    disp('----------------------------------------');
 ...
 [c1ax1,c1ay1] = CBCD1(A_amd, b1_amd, d, iters,pre1,l,u,init);
    ...
    disp('----------------------------------------');
    disp(['||Suite ncvx: ' matClass  '(b2); i=' num2str(i) '/' num2str(size(matList,1)) '; A_amd_1 done  ||']);
    disp('----------------------------------------');
 ...
 [c0rx1,c0ry1] = CBCD1(A_rcm, b1_rcm, d, iters,pre1,l,u,init);
    ...
    disp('----------------------------------------');
    disp(['||Suite ncvx: ' matClass  '(b2); i=' num2str(i) '/' num2str(size(matList,1)) '; A_rcm_0 done  ||']);
    disp('----------------------------------------');
 ...
 [c1rx1,c1ry1] = CBCD1(A_rcm, b1_rcm, d, iters,pre1,l,u,init);
    ...
    disp('----------------------------------------');
    disp(['||Suite ncvx: ' matClass  '(b2); i=' num2str(i) '/' num2str(size(matList,1)) '; A_rcm_1 done  ||']);
    disp('----------------------------------------');  
